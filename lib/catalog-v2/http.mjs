...
// Canonical negotiation contract: shared caches must not reuse a representation
// across Accept variants, and must revalidate compressed vs. identity encodings.
...
function notModified(etag, cacheControl) {
  return new Response(null, {
    status: 304,
    headers: { ETag: etag, "Cache-Control": cacheControl, Vary: NEGOTIATION_VARY },
  });
}
